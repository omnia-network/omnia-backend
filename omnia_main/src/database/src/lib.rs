...
impl State {
    ...
    pub fn get_virtual_persona_by_principal(&mut self, virtual_persona_principal: &Principal) -> Option<VirtualPersona> {
        match self.virtual_personas.get(virtual_persona_principal) {
